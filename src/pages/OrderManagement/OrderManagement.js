...
const OrderManagement = () => {
  ...
  const handleUpdateOrderStatus = async (orderId) => {
    try {
      ...
      await OrderService.updateOrder(user.id, orderId, { isDelivered: true }, user.access_token);
      setOrders([...orders]); 
                  ...
                  >
                    ...
                    <div style={{ padding: 0 }} className="col-md-6 d-flex">
                      <ul className="Order-body-top-right">
                        <li>{order.isPaid ? 'Đã xác nhận' : 'Chưa xác nhận'}</li>
                        <div
                          style={{
                            height: 13,
                            width: 1,
                        ...
                        ></div>
                        <li>{order.isDelivered ? 'Đã nhận hàng' : 'Chưa nhận hàng'}</li>
                      </ul>
                    </div>
                  </div>
                  ...
                  <div className="row flex float-right py-2">
                    ...
                    {order.isPaid && !order.isDelivered && (
                      <div style={{ marginTop: 20 }}>
                        <button
                        style={{float:'right', backgroundColor:'rgb(212, 0, 25)', border:'none'}}
